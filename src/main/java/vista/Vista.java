...
public class Vista {
    ...
    public void menuOperacionesAdmin(){
        ...
        System.out.println("\t7)Eliminar registro de administrador");
        System.out.println("\t8)Generar y/o Actualizar numeros de inscripcion");
    ...
    public void menuActualizarDatos(boolean usuario){                                         //usuario -> true para Admin a alum usuario -> false para admin a admin
        if(usuario){
            ...
            System.out.println("\t11) Semestres Activo");
